...
NVTX_DECLSPEC void NVTX_API nvtxNameClDeviceA(cl_device_id device, const char* name)
{
  ...
  nvtxNameClDeviceA_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClDeviceA_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClDeviceA_impl_fnptr);
...
NVTX_DECLSPEC void NVTX_API nvtxNameClDeviceW(cl_device_id device, const wchar_t* name)
{
  ...
  nvtxNameClDeviceW_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClDeviceW_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClDeviceW_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(device, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClContextA(cl_context context, const char* name)
{
  ...
  nvtxNameClContextA_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClContextA_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClContextA_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(context, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClContextW(cl_context context, const wchar_t* name)
{
  ...
  nvtxNameClContextW_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClContextW_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClContextW_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(context, name);
#endif /* NVTX_DISABLE */
}
                                                    ...
                                                    const char* name)
{
  ...
  (void)name;
#else  /* NVTX_DISABLE */
  nvtxNameClCommandQueueA_impl_fntype local = NVTX_REINTERPRET_CAST(
    nvtxNameClCommandQueueA_impl_fntype,
    NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClCommandQueueA_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(command_queue, name);
#endif /* NVTX_DISABLE */
}
                                                    ...
                                                    const wchar_t* name)
{
  ...
  (void)name;
#else  /* NVTX_DISABLE */
  nvtxNameClCommandQueueW_impl_fntype local = NVTX_REINTERPRET_CAST(
    nvtxNameClCommandQueueW_impl_fntype,
    NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClCommandQueueW_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(command_queue, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClMemObjectA(cl_mem memobj, const char* name)
{
  ...
  nvtxNameClMemObjectA_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClMemObjectA_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClMemObjectA_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(memobj, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClMemObjectW(cl_mem memobj, const wchar_t* name)
{
  ...
  nvtxNameClMemObjectW_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClMemObjectW_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClMemObjectW_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(memobj, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClSamplerA(cl_sampler sampler, const char* name)
{
  ...
  nvtxNameClSamplerA_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClSamplerA_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClSamplerA_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(sampler, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClSamplerW(cl_sampler sampler, const wchar_t* name)
{
  ...
  nvtxNameClSamplerW_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClSamplerW_impl_fntype,
...
NVTX_DECLSPEC void NVTX_API nvtxNameClProgramA(cl_program program, const char* name)
{
  ...
  nvtxNameClProgramA_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClProgramA_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClProgramA_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(program, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClProgramW(cl_program program, const wchar_t* name)
{
  ...
  nvtxNameClProgramW_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClProgramW_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClProgramW_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(program, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClEventA(cl_event evnt, const char* name)
{
  ...
  nvtxNameClEventA_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClEventA_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClEventA_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(evnt, name);
#endif /* NVTX_DISABLE */
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameClEventW(cl_event evnt, const wchar_t* name)
{
  ...
  nvtxNameClEventW_impl_fntype local =
    NVTX_REINTERPRET_CAST(nvtxNameClEventW_impl_fntype,
                          NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClEventW_impl_fnptr);
  if (local != NVTX_NULLPTR) (*local)(evnt, name);
#endif /* NVTX_DISABLE */
}
