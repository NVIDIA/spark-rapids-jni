...
typedef nvtx_nvtxSyncUser_t(NVTX_API* nvtxDomainSyncUserCreate_fakeimpl_fntype)(
  nvtxDomainHandle_t domain, const nvtx_nvtxSyncUserAttributes_t* attribs);
...
typedef void(NVTX_API* nvtxDomainSyncUserAcquireSuccess_fakeimpl_fntype)(
  nvtx_nvtxSyncUser_t handle);
...
typedef void (*NvtxFunctionPointer)(
  void); /* generic uncallable function pointer, must be cast to appropriate function type */
...
typedef struct NvtxExportTableCallbacks {
  ...
  int(NVTX_API* GetModuleFunctionTable)(NvtxCallbackModule module,
