 ...
 */
#define NVTX_PAYLOAD_SCHEMA_ATTR(                                                              \
  struct_id, schema_name, schema_flags, schema_id, mask_add, num_entries)                      \
  nvtxPayloadSchemaAttr_t struct_id##Attr = {                                                  \
    /*.fieldMask = */ NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_TYPE |                                    \
      mask_add NVTX_PAYLOAD_SCHEMA_ATTR_FIELD_ENTRIES |                                        \
...
#define _NVTX_PAYLOAD_SCHEMA_ENTRY(struct_id, entry)          \
  {_NVTX_PAYLOAD_SCHEMA_ENTRY_FRONT entry offsetof(struct_id, \
                                                   _NVTX_PAYLOAD_SCHEMA_ENTRY_END entry)},

/* Handle up to 16 schema entries. */
#define _NVTX_PAYLOAD_SME1(s, e1, ...) _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1)
#define _NVTX_PAYLOAD_SME2(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME1(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME3(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME2(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME4(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME3(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME5(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME4(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME6(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME5(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME7(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME6(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME8(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME7(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME9(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME8(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME10(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME9(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME11(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME10(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME12(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME11(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME13(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME12(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME14(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME13(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME15(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME14(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_SME16(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_ENTRY(s, e1) _NVTX_PAYLOAD_SME15(s, __VA_ARGS__)

#define _NVTX_PAYLOAD_SCHEMA_ENTRIES(struct_id, ...)               \
  nvtxPayloadSchemaEntry_t struct_id##Schema[] = {NVTX_EXT_CONCAT( \
    _NVTX_PAYLOAD_SME, NVTX_EXT_NUM_ARGS(__VA_ARGS__))(struct_id, __VA_ARGS__){0, 0}};
...
#define _NVTX_DEFINE_S4S_6(struct_id, schema_name, prefix, schema_flags, schema_id, entries) \
  prefix _NVTX_PAYLOAD_SCHEMA_ENTRIES(struct_id, _NVTX_PAYLOAD_PASS_THROUGH entries)         \
    prefix NVTX_PAYLOAD_SCHEMA_ATTR(struct_id,                                               \
                                    schema_name,                                             \
                                    schema_flags,                                            \
                                    schema_id,                                               \
...
#define _NVTX_DEFINE_S4S_5(struct_id, schema_name, prefix, schema_flags, entries)    \
  prefix _NVTX_PAYLOAD_SCHEMA_ENTRIES(struct_id, _NVTX_PAYLOAD_PASS_THROUGH entries) \
    prefix NVTX_PAYLOAD_SCHEMA_ATTR(                                                 \
      struct_id,                                                                     \
      schema_name,                                                                   \
      schema_flags,                                                                  \
      0,                                                                             \
...
#define _NVTX_DEFINE_SCHEMA_FOR_STRUCT(struct_id, ...)                          \
  NVTX_EXT_CONCAT(_NVTX_DEFINE_S4S_, NVTX_EXT_NUM_ARGS(struct_id, __VA_ARGS__)) \
...
#define _NVTX_PAYLOAD_STRUCT2(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT1(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT3(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT2(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT4(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT3(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT5(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT4(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT6(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT5(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT7(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT6(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT8(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT7(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT9(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT8(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT10(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT9(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT11(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT10(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT12(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT11(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT13(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT12(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT14(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT13(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT15(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT14(__VA_ARGS__)
#define _NVTX_PAYLOAD_STRUCT16(e1, ...) \
  _NVTX_PAYLOAD_STRUCT_ENTRY(e1) _NVTX_PAYLOAD_STRUCT15(__VA_ARGS__)
...
#define _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(struct_id, entry) \
  {_NVTX_PAYLOAD_SCHEMA_INIT_ENTRY_FRONT entry offsetof(  \
    struct_id, _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY_END entry)},

/* Handle up to 16 schema entries. */
#define _NVTX_PAYLOAD_INIT_SME1(s, e1, ...) _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1)
#define _NVTX_PAYLOAD_INIT_SME2(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME1(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME3(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME2(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME4(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME3(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME5(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME4(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME6(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME5(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME7(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME6(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME8(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME7(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME9(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME8(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME10(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME9(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME11(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME10(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME12(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME11(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME13(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME12(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME14(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME13(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME15(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME14(s, __VA_ARGS__)
#define _NVTX_PAYLOAD_INIT_SME16(s, e1, ...) \
  _NVTX_PAYLOAD_SCHEMA_INIT_ENTRY(s, e1) _NVTX_PAYLOAD_INIT_SME15(s, __VA_ARGS__)

#define _NVTX_PAYLOAD_SCHEMA_INIT_ENTRIES(struct_id, ...)          \
  nvtxPayloadSchemaEntry_t struct_id##Schema[] = {NVTX_EXT_CONCAT( \
    _NVTX_PAYLOAD_INIT_SME, NVTX_EXT_NUM_ARGS(__VA_ARGS__))(struct_id, __VA_ARGS__){0, 0}};
...
#define _NVTX_DEFINE_STRUCT_WITH_SCHEMA(struct_id, ...)                         \
  NVTX_EXT_CONCAT(_NVTX_DEFINE_SWS_, NVTX_EXT_NUM_ARGS(struct_id, __VA_ARGS__)) \
  (struct_id, __VA_ARGS__)
