...
public class SparkResourceAdaptor
    extends
    RmmWrappingDeviceMemoryResource<RmmEventHandlerResourceAdaptor<RmmDeviceMemoryResource>> {
  /**
  ...
  private static native void poolThreadWorkingOnTasks(long handle, boolean isForShuffle,
  ...
  private static native void forceRetryOOM(long handle, long threadId, int numOOMs, int oomMode,
                                           int skipCount);
