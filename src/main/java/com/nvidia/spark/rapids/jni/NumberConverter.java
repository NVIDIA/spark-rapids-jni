...
public class NumberConverter {
   ...
   */
  public static ColumnVector convertCvCvCv(ColumnVector input, ColumnVector fromBase, ColumnVector toBase) {
    ...
    return new ColumnVector(convertCvCvCv(input.getNativeView(), fromBase.getNativeView(), toBase.getNativeView()));
  }
   ...
   */
  public static boolean isConvertOverflowCvCvCv(ColumnVector input, ColumnVector fromBase, ColumnVector toBase) {

    assert (input.getType().equals(DType.STRING)) : "Input must be strings";
    assert (fromBase.getType().equals(DType.INT32)) : "From base must be Integers";
    assert (toBase.getType().equals(DType.INT32)) : "To base must be Integers";

    return isConvertOverflowCvCvCv(input.getNativeView(), fromBase.getNativeView(), toBase.getNativeView());
  }
   ...
   * @return If overflow occurs, return true; otherwise, return false.
   */
  public static boolean isConvertOverflowCvCvS(ColumnVector input, ColumnVector fromBase, int toBase) {
   ...
   * @return If overflow occurs, return true; otherwise, return false.
   */
  public static boolean isConvertOverflowCvSCv(ColumnVector input, int fromBase, ColumnVector toBase) {
