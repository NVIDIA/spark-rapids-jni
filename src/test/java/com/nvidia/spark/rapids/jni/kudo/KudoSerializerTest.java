  ...
  static Table buildTestTable() {
    ...
    HostColumnVector.ListType listDateType = new HostColumnVector.ListType(true,
        new HostColumnVector.StructType(false,
            ...
            new HostColumnVector.BasicType(true, DType.INT32)));
    HostColumnVector.StructType dateType = new HostColumnVector.StructType(false,
            new HostColumnVector.BasicType(false, DType.INT8),
            new HostColumnVector.BasicType(true, DType.INT8));
...
//            null, null, null, null, null, null, null, null, null, null, null)
        .column(listMapType,
            singletonList(singletonList(struct("k1", "v1"))),
            singletonList(singletonList(struct("k4", "v4"))),
            null,
            null,
            null,
            singletonList(singletonList(struct("k8", "v8"))),
            singletonList(singletonList(struct("k14", "v14"))),
            null,
            null,
            null,
            null,
            singletonList(singletonList(struct("k16", "v16"))),
            singletonList(singletonList(struct("k19", "v19"))),
            singletonList(singletonList(struct("k22", "v22"))),
            singletonList(null),
            singletonList(singletonList(struct("k22", null))),
            null,
            null)
