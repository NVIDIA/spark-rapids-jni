...
//        .column(dateType, struct(-210, 293), struct(647, null), null)
        .column(dateType, struct((byte)1, (byte)2), struct((byte)3, null), struct((byte)4, (byte)5))
//        .column(dateType, (HostColumnVector.StructData) null, null, null)
        .build();
  }
